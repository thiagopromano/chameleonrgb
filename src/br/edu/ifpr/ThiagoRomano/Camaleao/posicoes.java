...
public interface posicoes
{
	...
	public static final int X_DISABLED_ID = 16;
	public static final int ABOUT_ID = 17;
	public static final int ARCADE_ID = 18;
	public static final int BLACK_BEHIND_ID = 19;
	public static final int BOX_ID = 20;
